...
class StubData {
    ...
    static func createMessage() -> [MessageViewModel] {
        ...
        let secondMessage = Message(messageText: "This is the message text", creationDate: 1234, toId: "tmoney", fromId: "ty", type: "group", id: "2", isShare: true)
        ...
        let forthMessage = Message(messageText: "Just testing to see if it will hide the user profile", creationDate: 123, toId: "ty11", fromId: "SC", type: "text", id: "4", imageUrl: nil, imageWidth: nil, imageHeight: nil, isShare: false, username: nil, title: nil, postId: nil, localImage: nil)
        ...
        let seventhMessage = Message(messageText: "And another one lol", creationDate: 123, toId: "ty11", fromId: "ty", type: "text", id: "7", imageUrl: nil, imageWidth: nil, imageHeight: nil, isShare: false, username: nil, title: nil, postId: nil, localImage: nil)
